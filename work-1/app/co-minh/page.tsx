...
import { Layout, Input, Button, Typography, Popconfirm, Popover, Select, Tag } from "antd";
  ...
  return (
    <Layout style={{ minHeight: "100vh" }}>
      ...
      <Layout style={{ marginLeft: SIDEBAR_WIDTH }}>
        {/* Wrapper position:relative để overlay chỉ che phần chat, không che sidebar */}
        <div style={{ position: "relative", display: "flex", flexDirection: "column", height: "100vh" }}>
          ...
          {/* Name Overlay — chỉ che phần chat, không che sidebar */}
          {mounted && showNameModal && (
            ...
            >
              ...
              >
                <div style={{ fontSize: 20, fontWeight: 600, marginBottom: 8 }}>👋 Xin chào!</div>
